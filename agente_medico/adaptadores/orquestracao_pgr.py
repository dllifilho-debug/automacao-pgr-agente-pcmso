...
# [DERIVADO — D-ARQ-52; molde D-ARQ-47/orquestracao_fds.py]
...
def processar_arquivo_pgr(
    ...
    """Costura completa arquivo -> Resultado (D-ARQ-52).

    validade e assinatura_engenheiro são envelope por-parâmetro, RT-supplied
    nesta fatia; a FONTE real desses campos é a transcrição-de-topo do
    documento, fatia futura (D-ARQ-49 P2) — aqui apenas repassam ao PGR.
    ...
    pgr, pend_hidr = hidratar_pgr(aprovados, indice, validade, assinatura_engenheiro)
