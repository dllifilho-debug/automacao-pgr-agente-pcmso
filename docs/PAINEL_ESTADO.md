...
**Instrumento oficial nesta tiragem (disco, branch `feat/003dy-fuzzy-opt-in` sobre `main 1371845`):** regras **18/42** ativas (43%, sem drift desde 003.DK/DE) · vocabulário/CAS **50/79** slugs (63%, inalterado — 003.DY só adiciona campo `fuzzy_permitido`, nenhum slug/CAS novo) · suíte **949 passed, 6 skipped** (003.DY: +4 líquidos, D-ARQ-64). **Delta registrado, não corrigido:** a linha "Índice CAS" da Camada 1/2 abaixo ainda cita **21/45** (medição manual 003.AI, 23/06/2026) — 3 sessões (003.DK/DQ/DX) de defasagem entre o instrumento oficial e a prosa longa. O refresh dessa prosa segue deferido (ver Nota de escopo desta tiragem); o número correto de disco é o do instrumento, acima.
