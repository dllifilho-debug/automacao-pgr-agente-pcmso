...
**Tiragem corrente:** 003.DX · 24/07/2026
**Baseline:** main `d67872b` · 945 passed, 6 skipped · mypy `--strict` sem erro novo · PROTOCOLO v65 · DECISOES v146
...
**Instrumento oficial nesta tiragem (`scripts/medir_painel.py --suite`, disco, `main d67872b`):** regras **18/42** ativas (43%, sem drift desde 003.DK/DE) · vocabulário/CAS **50/79** slugs (63%) · suíte **945 passed, 6 skipped**. **Delta registrado, não corrigido:** a linha "Índice CAS" da Camada 1/2 abaixo ainda cita **21/45** (medição manual 003.AI, 23/06/2026) — 3 sessões (003.DK/DQ/DX) de defasagem entre o instrumento oficial e a prosa longa. O refresh dessa prosa segue deferido (ver Nota de escopo desta tiragem); o número correto de disco é o do instrumento, acima.
