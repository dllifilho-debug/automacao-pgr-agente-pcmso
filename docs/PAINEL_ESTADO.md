...
**Tiragem corrente:** 003.EC · 26/07/2026
**Baseline:** main `e3cba55` · 967 passed, 6 skipped · PROTOCOLO v69 · DECISOES v151
...
**Instrumento oficial nesta tiragem (disco, `main e3cba55`):** regras **20/42** ativas pelo instrumento (48%) / **19** pela intenção do painel (ver acima e DH-003EC-01(b)) · vocabulário/CAS **50/79** slugs (63%, inalterado desde 003.DK) · suíte **967 passed, 6 skipped** (003.EC: +4, testes de R-CLI-01; tempo de parede 1366s/22min46, insumo de DH-003EC-02). **Delta corrigido nesta tiragem:** a linha "Índice CAS" da Camada 1/2 abaixo citava **21/45** (medição manual 003.AI, 23/06/2026) — 5 sessões (003.DK/DQ/DX/EB/EC) de defasagem contra o instrumento. Substituída pelo número medido do instrumento, **50/79**, abaixo.
