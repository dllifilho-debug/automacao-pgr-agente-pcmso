...
Pendências (íntegra). Nenhuma D-ARQ, DT ou DH criada. Suíte 972→977 passed, 6 skipped (medido limpo @ `642a705`, +5 testes novos desta sessão — não é regressão da suíte herdada). Commits `c89f569`, `4abfeb5`, `642a705`. DECISOES inalterado (v154, correção de proveniência acima). PAINEL não re-tirado quanto aos 3 números clínicos (regras/cas/suíte-percentual não mudam de forma; só o instrumento e a 4ª linha mudaram).
