...
**Status:** ABERTA — ARQUITETURA RATIFICADA, liberada para IMPL a partir da fatia 2a (split cheap/expensive em `orquestracao_pgr.py`). `[MEDIDO — parsear_arquivo real contra o Fascino + leitura de estagios/pendencias_estruturais.py/PROTOCOLO_AGENTE_MEDICO.md §R-PGR-04, sessão claude/sharp-wozniak-j4596a; ratificação do Diovanni na mesma sessão]`
