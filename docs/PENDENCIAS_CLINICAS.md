...
### DT-003M-02 — Vocabulário (agentes.yaml) não cobre composição-de-FDS `[(A) PARCIALMENTE RESOLVIDA — 19 slugs novos, sessão docs/003fg-...; (B) FECHADA por D-ARQ-56, 003.CK]`
